...
makeWindowResizable(welcomeWindow);
makeWindowResizable(notesWindow);
...
function makeWindowResizable(windowElement){
    ...
    windowElement.addEventListener("mousemove", function(e){
        ...
        const nearLeft = mouseX >= rect.left &&
                         mouseX <= rect.left + resizeMargin;

        const nearRight = mouseX <= rect.right &&
                          mouseX >= rect.right - resizeMargin;
                          
        const nearTop = mouseY >= rect.top &&
                        mouseY <= rect.top + resizeMargin;

        const nearBottom = mouseY <= rect.bottom &&
                           mouseY >= rect.bottom - resizeMargin;
        ...
        windowElement.style.cursor = direction;
    ...
    windowElement.addEventListener("mousedown", function(e){
        ...
        if(nearTop && nearLeft){
            resizeDirection = "nw-resize";
        } else if(nearTop && nearRight){
            resizeDirection = "ne-resize";
        } else if(nearBottom && nearLeft){
            resizeDirection = "sw-resize";
        } else if(nearBottom && nearRight){
            resizeDirection = "se-resize";
        } else if(nearLeft){
            resizeDirection = "w-resize";
        } else if(nearRight){
            resizeDirection = "e-resize";
        } else if(nearTop){
            resizeDirection = "n-resize";
        } else if(nearBottom){
            resizeDirection = "s-resize";
        } else{
            resizeDirection = "";
        }
...
if(savedTerminalLeft !== null && savedTerminalTop !== null){
